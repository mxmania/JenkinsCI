...
public class AetherDemo
{
    ...
    {
        Aether aether = new Aether( "http://blrnexus:8081/nexus/content/repositories/central/", "C:\\Tangoe\\Projects\\AetherRepo" );
    ...
    public void displayTree() throws Exception 
    {
    	...
    	AetherResult result = aether.resolve(null, null, null);
